...
<form:form action="memJoin" method="post" name="frm" modelAttribute="memberCommand"> 
	<table border = 1 align="center">
		...
		<tr>
			<td>우편번호</td>
			<td>
				<form:input path="memAddrPost" id="sample4_postcode" readonly="readonly" />
			</td>
		</tr>
		<tr>
			<td>주소</td>
			<td><form:input path="memAddr" id="sample4_roadAddress" size="30" readonly="readonly" />
				<a href="javascript:sample4_execDaumPostcode();">주소 검색</a>
			</td>
		</tr>
		<tr>
			<td>상세주소</td>
			<td><form:input path="memAddrDetail" /></td>
			</tr>
		<tr>
			<td>연락처</td>
			<td><form:input path="memPh" /></td>
		</tr>
